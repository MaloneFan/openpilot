...
public:
  ...
  inline bool getDpLateralCameraOffset() const;

  inline bool getDpLateralPathOffset() const;
...
public:
  ...
  inline bool getDpLateralCameraOffset();
  inline void setDpLateralCameraOffset(bool value);

  inline bool getDpLateralPathOffset();
  inline void setDpLateralPathOffset(bool value);
...
inline bool DragonConf::Reader::getDpLateralCameraOffset() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<125>() * ::capnp::ELEMENTS);
}

inline bool DragonConf::Builder::getDpLateralCameraOffset() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<125>() * ::capnp::ELEMENTS);
}
inline void DragonConf::Builder::setDpLateralCameraOffset(bool value) {
  _builder.setDataField<bool>(
      ::capnp::bounded<125>() * ::capnp::ELEMENTS, value);
}

inline bool DragonConf::Reader::getDpLateralPathOffset() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<126>() * ::capnp::ELEMENTS);
}

inline bool DragonConf::Builder::getDpLateralPathOffset() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<126>() * ::capnp::ELEMENTS);
}
inline void DragonConf::Builder::setDpLateralPathOffset(bool value) {
  _builder.setDataField<bool>(
